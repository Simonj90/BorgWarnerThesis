...
\end{figure}
Applying torque on the tire will generate longitudinal force moving the tire forwards or backwards. Doing so will always generate a longitudinal slip, called \textit{slip ratio}. This is a ratio of the difference between the velocity of the tire and the actual velocity of the vehicle. The slip ratio is defined as: 
\begin{equation}
...
As can be seen in Figure \ref{slipangle_latforce} the lateral force is proportional to the slip angle for small slip angles.
\begin{figure}[h]
	\centering
