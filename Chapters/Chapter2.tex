...
When driving straight on a road with the same friction on both sides of the vehicle, both side axles and their wheels will have the same amount of torque applied and also the same velocity. The problem occurs when the vehicle wants to turn and the different wheels will have different turning radii, thus desiring different velocities. The general idea behind a differential is to be able to have different speeds on the different wheels in certain situations.
