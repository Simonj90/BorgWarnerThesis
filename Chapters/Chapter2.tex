...
Active differentials are controlled from the outside. The amount of torque transfered from one shaft to the other can be freely controlled and this gives much more power of the cars behavior.

\subsection{FXD}
The FXD is an active limited slip differential made for FWD cars.
